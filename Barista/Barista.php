...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['done'])) {
        ...
        // Update the productStatus column in ordersdetails table to 'Serving'
        $updateProductStatusSql = "UPDATE `ordersdetails` 
        SET productStatus = 'Serving' 
        WHERE orderID = '$orderId'";
        $updateSql = "UPDATE `orders` SET queueStatus = 'Preparing' WHERE order_id = '$orderId'";
...
$sql = "SELECT * FROM `ordersdetails` WHERE productStatus = 'Preparing' AND ($categoryCondition)";
